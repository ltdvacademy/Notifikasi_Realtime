...
import id.poncoe.notificationrealtime.notifikasi.java.NotificationUtils
import id.poncoe.notificationrealtime.notifikasi.java.Notifikasi
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun handleDataMessage(json: JSONObject) {
        ...
        try {
            ...
            val resultIntent = Intent(applicationContext, Notifikasi::class.java)
            ...
            println("in 1st CATCH")
        } catch (e: Exception) {
            Log.e(TAG, "Exception: " + e.message)
            println("in 2nd CATCH")
        }
    ...
    companion object {
        ...
        private val TAG = id.poncoe.notificationrealtime.notifikasi.java.MyFirebaseMessagingService::class.java.simpleName
    }
}